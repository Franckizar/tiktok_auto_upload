...
export const rawLessonsData = [
  { id: 1, subject: "Math", class: "10", teacher: "Mr. Smith" },
  { id: 2, subject: "English", class: "9", teacher: "Ms. Johnson" },
  // ...
];
...
export const calendarEvents = [
  ...
  // Monday, June 2, 2025
  {
    ...
    end: new Date(2025, 5, 2, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 5, 2, 9, 0),
    end: new Date(2025, 5, 2, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 5, 2, 10, 0),
    end: new Date(2025, 5, 2, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 5, 2, 11, 0),
    end: new Date(2025, 5, 2, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 5, 2, 13, 0),
    end: new Date(2025, 5, 2, 13, 45),
  },
  {
    title: "History",
    allDay: false,
  ...
  // Tuesday, June 3, 2025
  {
    ...
    end: new Date(2025, 5, 3, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 5, 3, 9, 0),
    end: new Date(2025, 5, 3, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 5, 3, 10, 0),
    end: new Date(2025, 5, 3, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 5, 3, 11, 0),
    end: new Date(2025, 5, 3, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 5, 3, 13, 0),
    end: new Date(2025, 5, 3, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 5, 3, 14, 0),
    end: new Date(2025, 5, 3, 14, 45),
  },
