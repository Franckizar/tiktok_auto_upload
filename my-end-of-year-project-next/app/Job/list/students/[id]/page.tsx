  ...
  return (
    <div className='flex-1 flex flex-col gap-4 p-4 xl:flex-row'>
      ...
      <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
        ...
        <h1 className='text-xl font-semibold'>Nhasting Arthur</h1>
...
{/* comeback */}
      ...
      <div className="flex-1 flex gap-4 justify-between flex-wrap">
        ...
        <div className="bg-white p--4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
          ...
          <div className="">
            <h1 className="text-xl font-semibold">SE3B</h1>
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
          ...
          <Link href="/" className="p-3 rounded-md bg-lamaPurpleLight">Student&apos;s Teacher</Link>
